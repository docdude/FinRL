...
class TensorboardCallback(BaseCallback):
    ...
    def _on_rollout_end(self) -> bool:
        try:
            ...
            # Handle the case where "rollout_buffer" is not found (expected for off-policy algorithms like DDPG, TD3, SAC)
            # These algorithms use replay buffers instead of rollout buffers
            ...
            # Suppressed: print("Logging Error:", error)
            pass
        return True
